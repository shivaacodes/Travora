...
export function GithubButton() {
    ...
    const fetchStars = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/shivaacodes/travora",
          {
        ...
        if (response.ok) {
          ...
          setStars(data.stargazer_count || stars); // Update stars if API response is valid
        }
      } catch (error) {
  ...
  return (
    <Link
      ...
      target="_blank"
      href="https://github.com/shivaacodes/travora"
    >
